...
download()
{
nwget http://cdn.mysql.com/Downloads/MySQL-5.6/mysql-5.6.16.tar.gz
nwget http://www.linuxfromscratch.org/patches/blfs/7.5/mysql-5.6.16-embedded_library_shared-1.patch

}
unpack()
{
preparepack "$pkgname" "$version" mysql-5.6.16.tar.gz
