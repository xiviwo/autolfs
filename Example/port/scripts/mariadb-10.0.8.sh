...
download()
{
nwget http://tweedo.com/mirror/mariadb/mariadb-10.0.8/kvm-tarbake-jaunty-x86/mariadb-10.0.8.tar.gz
nwget ftp://mirrors.fe.up.pt/pub/mariadb/mariadb-10.0.8/kvm-tarbake-jaunty-x86/mariadb-10.0.8.tar.gz

}
unpack()
{
preparepack "$pkgname" "$version" mariadb-10.0.8.tar.gz
