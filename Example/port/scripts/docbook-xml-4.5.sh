...
download()
{
nwget ftp://mirror.ovh.net/gentoo-distfiles/distfiles/docbook-xml-4.5.zip
nwget http://www.docbook.org/xml/4.5/docbook-xml-4.5.zip

}
unpack()
{
preparepack "$pkgname" "$version" docbook-xml-4.5.zip
