...
Source0:    http://www.surina.net/soundtouch/soundtouch-1.7.1.tar.gz
...
make pkgdocdir=${RPM_BUILD_ROOT}/usr/share/doc/soundtouch-1.7.1 install DESTDIR=${RPM_BUILD_ROOT} 
