...
Name:       xorg-savage-driver
Version:    2.3.6
Release:    %{?dist}7.4
License:    GPLv3+
Group:      Development/Tools
Requires:  xorg-server
Source0:    http://xorg.freedesktop.org/archive/individual/driver/xf86-video-savage-2.3.6.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/driver/xf86-video-savage-2.3.6.tar.bz2
