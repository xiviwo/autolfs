...
Requires:  vala
Source0:    http://ftp.gnome.org/pub/gnome/sources/libgee/0.6/libgee-0.6.8.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/libgee/0.6/libgee-0.6.8.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/libgee/0.6
%description
