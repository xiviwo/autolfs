...
Requires:  intltool
Requires:  itstool
Source0:    http://ftp.gnome.org/pub/gnome/sources/yelp-xsl/3.8/yelp-xsl-3.8.1.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/yelp-xsl/3.8/yelp-xsl-3.8.1.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/yelp-xsl/3.8
%description
