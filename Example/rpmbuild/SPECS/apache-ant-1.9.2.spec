...
Requires:  junit
Source0:    http://archive.apache.org/dist/ant/source/apache-ant-1.9.2-src.tar.bz2
...
./build.sh -Ddist.dir=${RPM_BUILD_ROOT}/opt/ant-1.9.2 dist 
ln -v -sfn ant-1.9.2 ${RPM_BUILD_ROOT}/opt/ant
