...
Source0:    http://dbus.freedesktop.org/releases/dbus/dbus-1.8.0.tar.gz
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/dbus-1.8.0
make install && DESTDIR=${RPM_BUILD_ROOT} 

mv -v ${RPM_BUILD_ROOT}/usr/share/doc/dbus ${RPM_BUILD_ROOT}/usr/share/doc/dbus-1.8.0
