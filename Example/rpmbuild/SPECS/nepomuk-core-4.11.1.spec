...
Requires:  exiv2
Requires:  ffmpeg
Source0:    http://download.kde.org/stable/4.11.1/src/nepomuk-core-4.11.1.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.11.1/src/nepomuk-core-4.11.1.tar.xz
