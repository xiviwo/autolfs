...
Requires:  gtk
Requires:  vala
Source0:    http://ftp.gnome.org/pub/gnome/sources/dconf/0.16/dconf-0.16.1.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/dconf/0.16/dconf-0.16.1.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/dconf/0.16
%description
