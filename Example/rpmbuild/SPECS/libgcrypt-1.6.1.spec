...
Source0:    ftp://ftp.gnupg.org/gcrypt/libgcrypt/libgcrypt-1.6.1.tar.bz2
...
install -v -dm755   ${RPM_BUILD_ROOT}/usr/share/doc/libgcrypt-1.6.1 &&

install -v -m644    README doc/{README.apichanges,fips*,libgcrypt*} ${RPM_BUILD_ROOT}/usr/share/doc/libgcrypt-1.6.1
