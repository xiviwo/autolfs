...
Summary:     The Anti-Grain Geometry (AGG) package contains a general purpose C++ graphical toolkit. It can be used in many areas of computer programming where high quality 2D graphics is an essential part of the project. 
Name:       agg
Version:    2.5
Release:    %{?dist}7.5
License:    GPLv3+
...
Source0:    http://www.antigrain.com/agg-2.5.tar.gz
