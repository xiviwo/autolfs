...
Source0:    http://graphviz.org/pub/graphviz/stable/SOURCES/graphviz-2.36.0.tar.gz
...
ln -v -s ${RPM_BUILD_ROOT}/usr/share/graphviz/doc ${RPM_BUILD_ROOT}/usr/share/doc/graphviz-2.36.0
