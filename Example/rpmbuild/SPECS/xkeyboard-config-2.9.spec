...
Source0:    http://xorg.freedesktop.org/archive/individual/data/xkeyboard-config/xkeyboard-config-2.9.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/data/xkeyboard-config/xkeyboard-config-2.9.tar.bz2
