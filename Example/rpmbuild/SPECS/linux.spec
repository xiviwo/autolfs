...
Summary:     The Linux API Headers (in linux-3.10.10.tar.xz) expose the kernel's API for use by Glibc. 
Name:       linux
Version:    1.0
Release:    %{?dist}7.4
License:    GPLv3+
...
mkdir -pv $RPM_BUILD_ROOT/tools/include
make headers_check
make INSTALL_HDR_PATH=dest headers_install DESTDIR=$RPM_BUILD_ROOT 

cp -rv dest/include/* ${RPM_BUILD_ROOT}/tools/include
