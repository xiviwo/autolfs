...
Requires:  which
Source0:    http://dl.lm-sensors.org/lm-sensors/releases/lm_sensors-3.3.4.tar.bz2
Source1:    ftp://ftp.netroedge.com/pub/lm-sensors/lm_sensors-3.3.4.tar.bz2
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/lm_sensors-3.3.4 

cp -rv              README INSTALL doc/* ${RPM_BUILD_ROOT}/usr/share/doc/lm_sensors-3.3.4
