...
Requires:  mtdev
Source0:    http://xorg.freedesktop.org/archive/individual/driver/xf86-input-evdev-2.8.2.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/driver/xf86-input-evdev-2.8.2.tar.bz2
