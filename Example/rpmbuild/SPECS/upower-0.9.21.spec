...
Requires:  pm-utils
Source0:    http://upower.freedesktop.org/releases/upower-0.9.21.tar.xz
...
%build
cd %{srcdir}
./configure --prefix=/usr --sysconfdir=/etc --enable-deprecated --disable-static --localstatedir=/var --libexecdir=/usr/lib/upower 
make %{?_smp_mflags} 
