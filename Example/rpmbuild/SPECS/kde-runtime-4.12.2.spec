...
Requires:  exiv2
Source0:    http://download.kde.org/stable/4.12.2/src/kde-runtime-4.12.2.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.12.2/src/kde-runtime-4.12.2.tar.xz
Source2:    http://www.linuxfromscratch.org/patches/blfs/7.5/kde-runtime-4.12.2-rpc_fix-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/kde-runtime-4.12.2-rpc_fix-1.patch &&
mkdir -pv build &&
cd    build &&
