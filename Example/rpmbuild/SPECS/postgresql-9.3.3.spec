...
Source0:    http://ftp.postgresql.org/pub/source/v9.3.3/postgresql-9.3.3.tar.bz2
Source1:    ftp://ftp.postgresql.org/pub/source/v9.3.3/postgresql-9.3.3.tar.bz2
URL:        http://ftp.postgresql.org/pub/source/v9.3.3
%description
