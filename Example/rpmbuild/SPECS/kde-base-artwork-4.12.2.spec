...
Requires:  kdelibs
Source0:    http://download.kde.org/stable/4.12.2/src/kde-base-artwork-4.12.2.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.12.2/src/kde-base-artwork-4.12.2.tar.xz
