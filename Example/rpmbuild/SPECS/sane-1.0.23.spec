...
Source0:    ftp://ftp2.sane-project.org/pub/sane/sane-backends-1.0.23.tar.gz
...
cd %{srcdir}
su $(whoami)
./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --with-docdir=/usr/share/doc/sane-backend-1.0.23 --with-group=scanner                             
make %{?_smp_mflags} 
