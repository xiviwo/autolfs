...
Source0:    ftp://ftp.gnupg.org/gcrypt/libgpg-error/libgpg-error-1.12.tar.bz2
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/libgpg-error-1.12
make install && DESTDIR=${RPM_BUILD_ROOT} 

install -v -m644 -D README ${RPM_BUILD_ROOT}/usr/share/doc/libgpg-error-1.12/README
