...
Requires:  expat
Requires:  libffi
Source0:    http://www.python.org/ftp/python/3.3.4/Python-3.3.4.tar.xz
Source1:    http://docs.python.org/ftp/python/doc/3.3.4/python-3.3.4-docs-html.tar.bz2
URL:        http://www.python.org/ftp/python/3.3.4
%description
...
export PYTHONDOCS=${RPM_BUILD_ROOT}/usr/share/doc/python-3.3.4/html
