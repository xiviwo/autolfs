...
Requires:  libogg
Source0:    http://downloads.xiph.org/releases/vorbis/libvorbis-1.3.4.tar.xz
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/libvorbis-1.3.4
make install && DESTDIR=${RPM_BUILD_ROOT} 

install -v -m644 doc/Vorbis* ${RPM_BUILD_ROOT}/usr/share/doc/libvorbis-1.3.4
