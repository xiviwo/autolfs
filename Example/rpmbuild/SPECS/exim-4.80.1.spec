...
Source0:    http://ftp.exim.org/pub/exim/exim4/exim-4.80.1.tar.bz2
Source1:    ftp://ftp.exim.org/pub/exim/exim4/exim-4.80.1.tar.bz2
...
install -v -d -m755 ${RPM_BUILD_ROOT}/usr/share/doc/exim-4.80.1 

install -v -m644 doc/* ${RPM_BUILD_ROOT}/usr/share/doc/exim-4.80.1 

ln -sv exim ${RPM_BUILD_ROOT}/usr/sbin/sendmail
