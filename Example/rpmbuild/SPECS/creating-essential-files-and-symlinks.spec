...
Summary:    creating-essential-files-and-symlinks
...
mkdir -pv ${RPM_BUILD_ROOT}/proc/self
mkdir -pv ${RPM_BUILD_ROOT}/bin
mkdir -pv ${RPM_BUILD_ROOT}/var/log/
ln -svf bash ${RPM_BUILD_ROOT}/bin/sh

ln -svf /proc/self/mounts ${RPM_BUILD_ROOT}/etc/mtab
