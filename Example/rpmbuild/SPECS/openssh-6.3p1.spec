...
Requires:  openssl
Source0:    http://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-6.3p1.tar.gz
Source1:    ftp://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-6.3p1.tar.gz
...
%build
cd %{srcdir}
./configure --prefix=/usr --libexecdir=/usr/lib/openssh --sysconfdir=/etc/ssh --datadir=/usr/share/sshd --with-md5-passwords --with-privsep-path=/var/lib/sshd 
make %{?_smp_mflags} 
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/openssh-6.3p1
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/openssh-6.3p1           

install -v -m644 INSTALL LICENCE OVERVIEW README* ${RPM_BUILD_ROOT}/usr/share/doc/openssh-6.3p1
