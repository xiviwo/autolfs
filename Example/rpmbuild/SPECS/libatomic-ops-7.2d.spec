...
Source0:    http://www.hpl.hp.com/research/linux/atomic_ops/download/libatomic_ops-7.2d.tar.gz
...
autoreconf -fi 
./configure --prefix=/usr --docdir=/usr/share/doc/libatomic_ops-7.2d --disable-static 
make %{?_smp_mflags} 
