...
Requires:  gpm
Requires:  openssl
Source0:    http://links.twibright.com/download/links-2.7.tar.bz2
Source1:    ftp://mirror.ovh.net/gentoo-distfiles/distfiles/links-2.7.tar.bz2
...
install -v -d -m755 ${RPM_BUILD_ROOT}/usr/share/doc/links-2.7 

install -v -m644 doc/links_cal/* KEYS BRAILLE_HOWTO ${RPM_BUILD_ROOT}/usr/share/doc/links-2.7
