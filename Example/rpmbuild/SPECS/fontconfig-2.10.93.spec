...
Requires:  freetype
Requires:  expat
Source0:    http://www.freedesktop.org/software/fontconfig/release/fontconfig-2.10.93.tar.bz2
...
%build
cd %{srcdir}
./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --docdir=/usr/share/doc/fontconfig-2.10.93 --disable-docs --disable-static 
make %{?_smp_mflags} 
