...
Requires:  gcr
Requires:  linux-pam
Source0:    http://ftp.gnome.org/pub/gnome/sources/gnome-keyring/3.8/gnome-keyring-3.8.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/gnome-keyring/3.8/gnome-keyring-3.8.2.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/gnome-keyring/3.8
%description
