...
Source0:    http://xorg.freedesktop.org/archive/individual/driver/xf86-video-vmware-13.0.1.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/driver/xf86-video-vmware-13.0.1.tar.bz2
Source2:    http://www.linuxfromscratch.org/patches/blfs/7.5/xf86-video-vmware-13.0.1-xatracker-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/xf86-video-vmware-13.0.1-xatracker-1.patch &&
