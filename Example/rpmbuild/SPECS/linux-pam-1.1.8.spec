...
Source0:    http://linux-pam.org/library/Linux-PAM-1.1.8.tar.bz2
Source1:    http://linux-pam.org/documentation/Linux-PAM-1.1.8-docs.tar.bz2
...
%build
cd %{srcdir}
tar -xf  %_sourcedir/Linux-PAM-1.1.8-docs.tar.bz2 --strip-components=1
