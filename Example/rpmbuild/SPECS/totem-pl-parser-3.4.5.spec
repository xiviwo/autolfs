...
Requires:  libarchive
Requires:  libgcrypt
Source0:    http://ftp.gnome.org/pub/gnome/sources/totem-pl-parser/3.4/totem-pl-parser-3.4.5.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/totem-pl-parser/3.4/totem-pl-parser-3.4.5.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/totem-pl-parser/3.4
%description
