...
Name:       xorg-openchrome-driver
Version:    0.3.3
Release:    %{?dist}7.5
License:    GPLv3+
Group:      Development/Tools
Requires:  xorg-server
Source0:    http://xorg.freedesktop.org/archive/individual/driver/xf86-video-openchrome-0.3.3.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/driver/xf86-video-openchrome-0.3.3.tar.bz2
