...
Requires:  openssl
Requires:  openldap
Source0:    http://downloads.sourceforge.net/virtuoso/virtuoso-opensource-6.1.8.tar.gz
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/virtuoso-6.1.8 &&

ln -svf   -v          ../../virtuoso/doc ${RPM_BUILD_ROOT}/usr/share/doc/virtuoso-6.1.8
