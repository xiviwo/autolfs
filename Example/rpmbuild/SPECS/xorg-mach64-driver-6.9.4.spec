...
Name:       xorg-mach64-driver
Version:    6.9.4
Release:    %{?dist}7.5
License:    GPLv3+
Group:      Development/Tools
Requires:  xorg-server
Source0:    http://xorg.freedesktop.org/archive/individual/driver/xf86-video-mach64-6.9.4.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/driver/xf86-video-mach64-6.9.4.tar.bz2
