...
Requires:  libpng
Source0:    http://poppler.freedesktop.org/poppler-0.24.5.tar.xz
...
install -v -m755 -d      ${RPM_BUILD_ROOT}/usr/share/doc/poppler-0.24.5 &&

install -v -m644 README* ${RPM_BUILD_ROOT}/usr/share/doc/poppler-0.24.5
