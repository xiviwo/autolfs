...
Source0:    http://www.sudo.ws/sudo/dist/sudo-1.8.7.tar.gz
Source1:    ftp://ftp.twaren.net/Unix/Security/Sudo/sudo-1.8.7.tar.gz
...
%build
cd %{srcdir}
./configure --prefix=/usr --libexecdir=/usr/lib/sudo --docdir=/usr/share/doc/sudo-1.8.7 --with-timedir=/var/lib/sudo --with-all-insults --with-env-editor                  
make %{?_smp_mflags} 
