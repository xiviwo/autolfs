...
Requires:  gjs
Requires:  pygobject
Source0:    http://ftp.gnome.org/pub/gnome/sources/libpeas/1.9/libpeas-1.9.0.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/libpeas/1.9/libpeas-1.9.0.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/libpeas/1.9
%description
