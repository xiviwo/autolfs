...
Source0:    http://www.unixodbc.org/unixODBC-2.3.2.tar.gz
Source1:    ftp://mirror.ovh.net/gentoo-distfiles/distfiles/unixODBC-2.3.2.tar.gz
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/unixODBC-2.3.2 &&

cp      -v -R doc/* ${RPM_BUILD_ROOT}/usr/share/doc/unixODBC-2.3.2
