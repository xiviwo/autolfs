...
Requires:  libdvdcss
Source0:    http://ftp.gnome.org/pub/gnome/sources/totem/3.8/totem-3.8.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/totem/3.8/totem-3.8.2.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/totem/3.8
%description
...
%build
cd %{srcdir}
./configure --prefix=/usr --libexecdir=/usr/lib/totem --disable-static 
make %{?_smp_mflags} 
