...
Source0:    http://downloads.sourceforge.net/mutt/mutt-1.5.22.tar.gz
Source1:    ftp://ftp.mutt.org/mutt/devel/mutt-1.5.22.tar.gz
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/mutt-1.5.22/samples
