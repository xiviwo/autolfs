...
Requires:  gtk
Requires:  libxml2
Source0:    http://distfiles.audacious-media-player.org/audacious-3.4.1.tar.bz2
Source1:    http://distfiles.audacious-media-player.org/audacious-plugins-3.4.1.tar.bz2
