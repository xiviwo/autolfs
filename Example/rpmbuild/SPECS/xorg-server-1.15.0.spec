...
Source0:    http://xorg.freedesktop.org/archive/individual/xserver/xorg-server-1.15.0.tar.bz2
Source1:    ftp://ftp.x.org/pub/individual/xserver/xorg-server-1.15.0.tar.bz2
Source2:    http://www.linuxfromscratch.org/patches/blfs/7.5/xorg-server-1.15.0-add_prime_support-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/xorg-server-1.15.0-add_prime_support-1.patch
