...
Requires:  libvpx
Requires:  x264
Source0:    http://ffmpeg.org/releases/ffmpeg-2.1.3.tar.bz2
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/ffmpeg &&

install -v -m644    doc/*.txt ${RPM_BUILD_ROOT}/usr/share/doc/ffmpeg

install -v -m644 doc/*.html ${RPM_BUILD_ROOT}/usr/share/doc/ffmpeg
