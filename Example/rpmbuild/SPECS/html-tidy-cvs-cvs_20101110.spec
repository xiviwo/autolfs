...
install -v -m644 -D htmldoc/tidy.1 ${RPM_BUILD_ROOT}/usr/share/man/man1/tidy.1 &&

install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/tidy-cvs_20101110 &&

install -v -m644    htmldoc/*.{html,gif,css} ${RPM_BUILD_ROOT}/usr/share/doc/tidy-cvs_20101110
