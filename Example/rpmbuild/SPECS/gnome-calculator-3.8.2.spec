...
Requires:  yelp-xsl
Requires:  vala
Source0:    http://ftp.gnome.org/pub/gnome/sources/gnome-calculator/3.8/gnome-calculator-3.8.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/gnome-calculator/3.8/gnome-calculator-3.8.2.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/gnome-calculator/3.8
%description
