...
Requires:  upower
Requires:  vala
Source0:    http://ftp.gnome.org/pub/gnome/sources/NetworkManager/0.9/NetworkManager-0.9.8.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/NetworkManager/0.9/NetworkManager-0.9.8.2.tar.xz
...
%build
cd %{srcdir}
./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --libexecdir=/usr/lib/NetworkManager --disable-ppp 
make %{?_smp_mflags} 
