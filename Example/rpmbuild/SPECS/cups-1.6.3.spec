...
Requires:  d-bus
Requires:  libusb
Source0:    http://www.cups.org/software/1.6.3/cups-1.6.3-source.tar.bz2
Source1:    http://www.linuxfromscratch.org/patches/blfs/svn/cups-1.6.3-blfs-1.patch
URL:        http://www.cups.org/software/1.6.3
%description
...
patch -Np1 -i %_sourcedir/cups-1.6.3-blfs-1.patch 
...
ln -sv ../cups/doc ${RPM_BUILD_ROOT}/usr/share/doc/cups-1.6.3
