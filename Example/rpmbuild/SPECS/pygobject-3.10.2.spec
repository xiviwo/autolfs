...
Requires:  py2cairo
Requires:  pycairo
Source0:    http://ftp.gnome.org/pub/gnome/sources/pygobject/3.10/pygobject-3.10.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/pygobject/3.10/pygobject-3.10.2.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/pygobject/3.10
%description
