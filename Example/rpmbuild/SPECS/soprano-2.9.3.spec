...
Requires:  libiodbc
Requires:  virtuoso
Source0:    http://downloads.sourceforge.net/soprano/soprano-2.9.3.tar.bz2
Source1:    http://www.linuxfromscratch.org/patches/blfs/svn/soprano-2.9.3-dbus-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/soprano-2.9.3-dbus-1.patch 
mkdir -pv build 
cd build    
