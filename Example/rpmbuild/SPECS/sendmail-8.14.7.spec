...
Requires:  openldap
Source0:    ftp://ftp.sendmail.org/pub/sendmail/sendmail.8.14.7.tar.gz
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/man/man8
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/sendmail
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/man/man5
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/cf
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/{cf,sendmail} 

install -v -m644 CACerts FAQ KNOWNBUGS LICENSE PGPKEYS README RELEASE_NOTES ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7 

install -v -m644 sendmail/{README,SECURITY,TRACEFLAGS,TUNING} ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/sendmail 

install -v -m644 cf/README ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7/cf 
...
make op.txt op.pdf
install -v -d -m755 ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7 

install -v -m644 op.ps op.txt op.pdf ${RPM_BUILD_ROOT}/usr/share/doc/sendmail-8.14.7 
