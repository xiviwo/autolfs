...
Requires:  libgcrypt
Requires:  gnutls
Source0:    http://downloads.sourceforge.net/pidgin/pidgin-2.10.9.tar.bz2
...
mkdir -pv -pv ${RPM_BUILD_ROOT}/usr/share/doc/pidgin-2.10.9 &&

cp -v README doc/gtkrc-2.0 ${RPM_BUILD_ROOT}/usr/share/doc/pidgin-2.10.9
