...
Requires:  lame
Requires:  libdvdread
Source0:    http://gstreamer.freedesktop.org/src/gst-plugins-ugly/gst-plugins-ugly-1.0.10.tar.xz
...
%build
cd %{srcdir}
./configure --prefix=/usr --with-package-name="GStreamer Ugly Plugins 1.0.10 BLFS" --with-package-origin="http://www.linuxfromscratch.org/blfs/view/svn/" 
make %{?_smp_mflags} 
