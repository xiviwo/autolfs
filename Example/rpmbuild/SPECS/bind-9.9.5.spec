...
Summary:     The BIND package provides a DNS server and client utilities. If you are only interested in the utilities, refer to the BIND Utilities-9.9.5. 
Name:       bind
Version:    9.9.5
Release:    %{?dist}7.5
License:    GPLv3+
...
Source1:    http://www.linuxfromscratch.org/patches/blfs/7.5/bind-9.9.5-use_iproute2-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/bind-9.9.5-use_iproute2-1.patch
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/bind-9.9.5
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/bind-9.9.5/{arm,misc} &&

install -v -m644    doc/arm/*.html ${RPM_BUILD_ROOT}/usr/share/doc/bind-9.9.5/arm &&

install -v -m644 doc/misc/{dnssec,ipv6,migrat*,options,rfc-compliance,roadmap,sdb} ${RPM_BUILD_ROOT}/usr/share/doc/bind-9.9.5/misc
