...
Requires:  sqlite
Requires:  yasm
Source0:    http://releases.mozilla.org/pub/mozilla.org/thunderbird/releases/17.0.8/source/thunderbird-17.0.8.source.tar.bz2
Source1:    ftp://ftp.mozilla.org/pub/mozilla.org/thunderbird/releases/17.0.8/source/thunderbird-17.0.8.source.tar.bz2
Source2:    http://www.linuxfromscratch.org/patches/blfs/svn/thunderbird-17.0.8-system_cairo-1.patch
URL:        http://releases.mozilla.org/pub/mozilla.org/thunderbird/releases/17.0.8/source
%description
...
EOF
patch -Np1 -i %_sourcedir/thunderbird-17.0.8-system_cairo-1.patch

%install
cd %{srcdir}
rm -rf ${RPM_BUILD_ROOT}

mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/thunderbird-17.0.8/chrome/icons/default
...
mkdir -pv -pv ${RPM_BUILD_ROOT}/usr/lib/thunderbird-17.0.8 

tar -xvf thunderbuild/mozilla/dist/thunderbird-17.0.8.en-US.linux-$(uname -m).tar.bz2 -C ${RPM_BUILD_ROOT}/usr/lib/thunderbird-17.0.8 --strip-components=1 

ln -sfv ../lib/thunderbird-17.0.8/thunderbird ${RPM_BUILD_ROOT}/usr/bin
...
StartupNotify=true
EOF
ln -sfv /usr/lib/thunderbird-17.0.8/chrome/icons/default/default256.png ${RPM_BUILD_ROOT}/usr/share/pixmaps/thunderbird.png
