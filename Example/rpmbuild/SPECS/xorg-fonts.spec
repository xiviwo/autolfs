...
Summary:     The Xorg font packages provide needed fonts to the Xorg applications. 
Name:       xorg-fonts
Version:    1.0
Release:    %{?dist}7.5
License:    GPLv3+
...
URL:        http://www.linuxfromscratch.org/blfs/view/stable/x/x7font.html
%description
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/fonts
...
exit
install -v -d -m755 ${RPM_BUILD_ROOT}/usr/share/fonts                               &&

ln -svfn $XORG_PREFIX/share/fonts/X11/OTF ${RPM_BUILD_ROOT}/usr/share/fonts/X11-OTF &&

ln -svfn $XORG_PREFIX/share/fonts/X11/TTF ${RPM_BUILD_ROOT}/usr/share/fonts/X11-TTF
