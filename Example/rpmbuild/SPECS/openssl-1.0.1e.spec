...
Source0:    http://www.openssl.org/source/openssl-1.0.1e.tar.gz
Source1:    ftp://ftp.openssl.org/source/openssl-1.0.1e.tar.gz
Source2:    http://www.linuxfromscratch.org/patches/blfs/svn/openssl-1.0.1e-fix_parallel_build-1.patch
Source3:    http://www.linuxfromscratch.org/patches/blfs/svn/openssl-1.0.1e-fix_pod_syntax-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/openssl-1.0.1e-fix_parallel_build-1.patch 
patch -Np1 -i %_sourcedir/openssl-1.0.1e-fix_pod_syntax-1.patch 
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/openssl-1.0.1e
make MANDIR=${RPM_BUILD_ROOT}/usr/share/man MANSUFFIX=ssl install  DESTDIR=${RPM_BUILD_ROOT} 

install -dv -m755 ${RPM_BUILD_ROOT}/usr/share/doc/openssl-1.0.1e  

cp -vfr doc/*     ${RPM_BUILD_ROOT}/usr/share/doc/openssl-1.0.1e
