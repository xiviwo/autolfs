...
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1/browser/icons
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/applications
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1
make -C firefox-build-dir/browser/installer DESTDIR=${RPM_BUILD_ROOT} 

rm -rf ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1 &&

mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1 &&

tar -xvf firefox-build-dir/dist/firefox-27.0.1.en-US.linux-$(uname -m).tar.bz2 -C ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1 --strip-components=1 &&

ln -sfv ../lib/firefox-27.0.1/firefox ${RPM_BUILD_ROOT}/usr/bin &&

mkdir -pv -pv ${RPM_BUILD_ROOT}/usr/lib/mozilla/plugins &&

ln -sfv ../mozilla/plugins ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1

make -C firefox-build-dir install && DESTDIR=${RPM_BUILD_ROOT} 

ln -sfv ../lib/firefox-27.0.1/firefox ${RPM_BUILD_ROOT}/usr/bin &&

ln -sfv ../xulrunner-27.0.1 ${RPM_BUILD_ROOT}/usr/lib/firefox-27.0.1/xulrunner &&
...
StartupNotify=true
EOF
ln -sfv /usr/lib/firefox-27.0.1/browser/icons/mozicon128.png ${RPM_BUILD_ROOT}/usr/share/pixmaps/firefox.png
