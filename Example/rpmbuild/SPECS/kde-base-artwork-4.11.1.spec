...
Requires:  kdelibs
Source0:    http://download.kde.org/stable/4.11.1/src/kde-base-artwork-4.11.1.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.11.1/src/kde-base-artwork-4.11.1.tar.xz
