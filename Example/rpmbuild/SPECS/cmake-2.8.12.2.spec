...
Requires:  libarchive
Requires:  expat
Source0:    http://www.cmake.org/files/v2.8/cmake-2.8.12.2.tar.gz
Source1:    http://www.linuxfromscratch.org/patches/blfs/7.5/cmake-2.8.12.2-freetype-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/cmake-2.8.12.2-freetype-1.patch &&
