...
Requires:  p11-kit
Source0:    http://ftp.gnome.org/pub/gnome/sources/glib-networking/2.38/glib-networking-2.38.2.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/glib-networking/2.38/glib-networking-2.38.2.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/glib-networking/2.38
%description
