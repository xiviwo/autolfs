...
Requires:  pcre
Requires:  openssl
Source0:    http://archive.apache.org/dist/httpd/httpd-2.4.7.tar.bz2
Source1:    http://www.linuxfromscratch.org/patches/blfs/7.5/httpd-2.4.7-blfs_layout-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/httpd-2.4.7-blfs_layout-1.patch &&
