...
Requires:  nspr
Requires:  sqlite
Source0:    http://ftp.mozilla.org/pub/mozilla.org/security/nss/releases/NSS_3_15_1_RTM/src/nss-3.15.1.tar.gz
Source1:    ftp://ftp.mozilla.org/pub/mozilla.org/security/nss/releases/NSS_3_15_1_RTM/src/nss-3.15.1.tar.gz
Source2:    http://www.linuxfromscratch.org/patches/blfs/svn/nss-3.15.1-standalone-2.patch
URL:        http://ftp.mozilla.org/pub/mozilla.org/security/nss/releases/NSS_3_15_1_RTM/src
%description
...
cd nss 
make BUILD_OPT=1 NSPR_INCLUDE_DIR=${RPM_BUILD_ROOT}/usr/include/nspr USE_SYSTEM_ZLIB=1 ZLIB_LIBS=-lz $([ $(uname -m) = x86_64 ] && echo USE_64=1) $([ -f ${RPM_BUILD_ROOT}/usr/include/sqlite3.h ] && echo NSS_USE_SYSTEM_SQLITE=1)
