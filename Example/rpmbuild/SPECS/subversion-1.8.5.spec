...
Requires:  openssl
Requires:  serf
Source0:    http://archive.apache.org/dist/subversion/subversion-1.8.5.tar.bz2
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/subversion-1.8.5 &&

cp      -v -R       doc/* ${RPM_BUILD_ROOT}/usr/share/doc/subversion-1.8.5
