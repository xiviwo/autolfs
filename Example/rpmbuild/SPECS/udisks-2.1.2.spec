...
Summary:     The UDisks package provides a daemon, tools and libraries to access and manipulate disks and storage devices. 
Name:       udisks
Version:    2.1.2
Release:    %{?dist}7.5
License:    GPLv3+
...
Source0:    http://udisks.freedesktop.org/releases/udisks-2.1.2.tar.bz2
