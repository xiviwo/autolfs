...
Requires:  libffi
Requires:  pkg-config
Source0:    http://www.python.org/ftp/python/2.7.5/Python-2.7.5.tar.xz
Source1:    http://docs.python.org/ftp/python/doc/2.7.5/python-2.7.5-docs-html.tar.bz2
URL:        http://www.python.org/ftp/python/2.7.5
%description
...
export PYTHONDOCS=${RPM_BUILD_ROOT}/usr/share/doc/python-2.7.5
