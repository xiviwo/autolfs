...
Source0:    http://download.kde.org/stable/phonon/phonon-backend-gstreamer/4.7.1/phonon-backend-gstreamer-4.7.1.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/phonon/phonon-backend-gstreamer/4.7.1/phonon-backend-gstreamer-4.7.1.tar.xz
URL:        http://download.kde.org/stable/phonon/phonon-backend-gstreamer/4.7.1
%description
