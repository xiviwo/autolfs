...
Summary:     MySQL is a widely used and fast SQL database server. It is a client/server implementation that consists of a server daemon and many different client programs and libraries. 
Name:       mysql
Version:    5.6.13
Release:    %{?dist}7.4
License:    GPLv3+
...
Requires:  libevent
Requires:  openssl
Source0:    http://cdn.mysql.com/Downloads/MySQL-5.6/mysql-5.6.13.tar.gz
Source1:    http://www.linuxfromscratch.org/patches/blfs/svn/mysql-5.6.13-embedded_library_shared-1.patch
URL:        http://cdn.mysql.com/Downloads/MySQL-5.6
%description
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/mysql-5.6.13-embedded_library_shared-1.patch
