...
Requires:  zip
Source0:    http://icedtea.classpath.org/download/source/icedtea-2.4.1.tar.gz
Source1:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/corba.tar.gz
Source2:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/hotspot.tar.gz
Source3:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/openjdk.tar.gz
Source4:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/jaxp.tar.gz
Source5:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/jaxws.tar.gz
Source6:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/langtools.tar.gz
Source7:    http://anduin.linuxfromscratch.org/files/BLFS/OpenJDK-1.7.0.40/jdk.tar.gz
Source8:    http://www.linuxfromscratch.org/patches/blfs/svn/icedtea-2.4.1-add_cacerts-2.patch
Source9:    http://www.linuxfromscratch.org/patches/blfs/svn/icedtea-2.4.1-fixed_paths-1.patch
Source10:    http://www.linuxfromscratch.org/patches/blfs/svn/icedtea-2.4.1-fix_tests-1.patch
...
unset JAVA_HOME &&
./autogen.sh    &&
./configure --with-jdk-home=${RPM_BUILD_ROOT}/opt/OpenJDK-1.7.0.40-bin \
            --enable-nss                              \
...
cp -R openjdk.build/j2sdk-image ${RPM_BUILD_ROOT}/opt/OpenJDK-1.7.0.40 &&
chown -R root:root ${RPM_BUILD_ROOT}/opt/OpenJDK-1.7.0.40
ln -v -nsf OpenJDK-1.7.0.40-bin ${RPM_BUILD_ROOT}/opt/jdk
cat > ${RPM_BUILD_ROOT}/etc/profile.d/openjdk.sh << "EOF"
...
EOF
cat >> ${RPM_BUILD_ROOT}/etc/man_db.conf << "EOF" &&
...
cat > ${RPM_BUILD_ROOT}/opt/jdk/bin/mkcacerts << "EOF"
#!/bin/sh
...
exit 0
EOF
chmod -c 0755 ${RPM_BUILD_ROOT}/opt/jdk/bin/mkcacerts
