...
Source0:    http://ftp.gnome.org/pub/gnome/sources/pyatspi/2.10/pyatspi-2.10.0.tar.xz
Source1:    ftp://ftp.gnome.org/pub/gnome/sources/pyatspi/2.10/pyatspi-2.10.0.tar.xz
URL:        http://ftp.gnome.org/pub/gnome/sources/pyatspi/2.10
%description
