...
Requires:  libevent
Requires:  openssl
Source0:    http://cdn.mysql.com/Downloads/MySQL-5.6/mysql-5.6.16.tar.gz
Source1:    http://www.linuxfromscratch.org/patches/blfs/7.5/mysql-5.6.16-embedded_library_shared-1.patch
...
%build
cd %{srcdir}
patch -Np1 -i %_sourcedir/mysql-5.6.16-embedded_library_shared-1.patch
