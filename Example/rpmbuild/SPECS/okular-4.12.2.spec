...
Summary:     Okular is a document viewer for KDE. It can view documents of many types including PDF, PostScript, TIFF, Microsoft CHM, DjVu, DVI, XPS and ePub. 
Name:       okular
Version:    4.12.2
Release:    %{?dist}7.5
License:    GPLv3+
...
Requires:  poppler
Source0:    http://download.kde.org/stable/4.12.2/src/okular-4.12.2.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.12.2/src/okular-4.12.2.tar.xz
