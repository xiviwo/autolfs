...
Requires:  cyrus-sasl
Requires:  openssl
Source0:    ftp://ftp.porcupine.org/mirrors/postfix-release/official/postfix-2.11.0.tar.gz
...
make CCARGS="-DUSE_TLS -I/usr/include/openssl/ -DUSE_SASL_AUTH -DUSE_CYRUS_SASL -I/usr/include/sasl" AUXLIBS="-lssl -lcrypto -lsasl2" makefiles && %{?_smp_mflags} 
