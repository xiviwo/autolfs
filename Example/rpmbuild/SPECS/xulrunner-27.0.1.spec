...
Requires:  sqlite
Requires:  yasm
Source0:    http:///ftp.mozilla.org/pub/mozilla.org/firefox/releases/27.0.1/source/firefox-27.0.1.source.tar.bz2
Source1:    ftp://ftp.mozilla.org/pub/mozilla.org/firefox/releases/27.0.1/source/firefox-27.0.1.source.tar.bz2
URL:        http:///ftp.mozilla.org/pub/mozilla.org/firefox/releases/27.0.1/source
%description
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/xulrunner-27.0.1
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/xulrunner-devel-27.0.1/sdk/bin
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib
mkdir -pv ${RPM_BUILD_ROOT}/usr/lib/xulrunner-devel-27.0.1/sdk/lib
...
rm -rf ${RPM_BUILD_ROOT}/usr/lib/xulrunner-27.0.1/plugins &&

ln -svf  %_sourcedir/mozilla/plugins ${RPM_BUILD_ROOT}/usr/lib/xulrunner-27.0.1 &&

for library in libmozalloc.so libmozjs.so libxul.so; do
    ln -sfv ../../../xulrunner-27.0.1/$library ${RPM_BUILD_ROOT}/usr/lib/xulrunner-devel-27.0.1/sdk/lib/$library

    ln -sfv xulrunner-27.0.1/$library ${RPM_BUILD_ROOT}/usr/lib/$library

done
ln -sfv ../xulrunner-devel-27.0.1/sdk/bin/run-mozilla.sh ${RPM_BUILD_ROOT}/usr/lib/xulrunner-27.0.1

ln -sfv ../xulrunner-devel-27.0.1/sdk/bin/xpcshell ${RPM_BUILD_ROOT}/usr/lib/xulrunner-27.0.1
