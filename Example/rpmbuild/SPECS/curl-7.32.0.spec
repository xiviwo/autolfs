...
Requires:  openssl
Source0:    http://curl.haxx.se/download/curl-7.32.0.tar.bz2
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/curl-7.32.0
make install  DESTDIR=${RPM_BUILD_ROOT} 

find docs \( -name "Makefile*" -o -name "*.1" -o -name "*.3" \) -exec rm {} \; 
install -v -d -m755 ${RPM_BUILD_ROOT}/usr/share/doc/curl-7.32.0 

cp -v -R docs/*     ${RPM_BUILD_ROOT}/usr/share/doc/curl-7.32.0
