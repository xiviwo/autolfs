...
Requires:  yasm
Source0:    http://gstreamer.freedesktop.org/src/gst-libav/gst-libav-1.0.10.tar.xz
...
%build
cd %{srcdir}
./configure --prefix=/usr --with-package-name="GStreamer Libav Plugins 1.0.10 BLFS" --with-package-origin="http://www.linuxfromscratch.org/blfs/view/svn/" 
make %{?_smp_mflags} 
