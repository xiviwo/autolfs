...
Requires:  pciutils
Requires:  consolekit
Source0:    http://download.kde.org/stable/4.11.1/src/kde-workspace-4.11.1.tar.xz
Source1:    ftp://ftp.kde.org/pub/kde/stable/4.11.1/src/kde-workspace-4.11.1.tar.xz
...
mkdir -pv build 
cd    build 
cmake -DCMAKE_INSTALL_PREFIX=$KDE_PREFIX -DSYSCONF_INSTALL_DIR=/etc -DCMAKE_BUILD_TYPE=Release -DINSTALL_PYTHON_FILES_IN_PYTHON_PREFIX=TRUE .. 
make %{?_smp_mflags} 
