...
Requires:  glib
Requires:  libpcap
Source0:    http://www.wireshark.org/download/src/all-versions/wireshark-1.10.2.tar.bz2
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/wireshark-1.10.2 

install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/pixmaps/wireshark 

install -v -m644    README{,.linux} doc/README.* doc/*.{pod,txt} ${RPM_BUILD_ROOT}/usr/share/doc/wireshark-1.10.2 

pushd ${RPM_BUILD_ROOT}/usr/share/doc/wireshark-1.10.2 
...
install -v -m644 <Downloaded_Files> ${RPM_BUILD_ROOT}/usr/share/doc/wireshark-1.10.2
