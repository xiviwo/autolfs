...
Source0:    http://downloads.sourceforge.net/enlightenment/imlib2-1.4.5.tar.bz2
...
install -v -m755 -d ${RPM_BUILD_ROOT}/usr/share/doc/imlib2-1.4.5 

install -v -m644    doc/{*.gif,index.html} ${RPM_BUILD_ROOT}/usr/share/doc/imlib2-1.4.5
