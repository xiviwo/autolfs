...
Source0:    http://ftp.stack.nl/pub/doxygen/doxygen-1.8.6.src.tar.gz
Source1:    ftp://ftp.stack.nl/pub/doxygen/doxygen-1.8.6.src.tar.gz
...
make MAN1DIR=share/man/man1 install DESTDIR=${RPM_BUILD_ROOT} 
