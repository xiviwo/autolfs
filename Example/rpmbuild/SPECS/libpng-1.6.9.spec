...
Source0:    http://downloads.sourceforge.net/libpng/libpng-1.6.9.tar.xz
Source1:    http://downloads.sourceforge.net/libpng-apng/libpng-1.6.9-apng.patch.gz
...
%build
cd %{srcdir}
gzip -cd  %_sourcedir/libpng-1.6.9-apng.patch.gz | patch -p1
...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/libpng-1.6.9
make install && DESTDIR=${RPM_BUILD_ROOT} 

mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/libpng-1.6.9 &&

cp -v README libpng-manual.txt ${RPM_BUILD_ROOT}/usr/share/doc/libpng-1.6.9
