...
mkdir -pv ${RPM_BUILD_ROOT}/usr/share/doc/linux-3.13.3
mkdir -pv ${RPM_BUILD_ROOT}/etc/modprobe.d
make modules_install INSTALL_MOD_PATH=${RPM_BUILD_ROOT}  DESTDIR=${RPM_BUILD_ROOT} 

cp -v arch/x86/boot/bzImage ${RPM_BUILD_ROOT}/boot/vmlinuz-3.13.3-lfs-7.5

cp -v System.map ${RPM_BUILD_ROOT}/boot/System.map-3.13.3

cp -v .config ${RPM_BUILD_ROOT}/boot/config-3.13.3

install -d ${RPM_BUILD_ROOT}/usr/share/doc/linux-3.13.3

cp -r Documentation/* ${RPM_BUILD_ROOT}/usr/share/doc/linux-3.13.3
