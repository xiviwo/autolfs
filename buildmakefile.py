...
if not containsAny(release, ['stable','development','7.4-rc1','7.4']):
...
firsttgt="all : download mk_env mk_tools mk_virt_file mk_chroot mk_config mk_boot mk_end mk_blfs umount_all"
...
def genscript(links,ccounter,rules,subtarget):
	...
	for link in links:	
		...
		if hasattr(link,"href") and not containsAny(func, ['chroot','package-management','cleaning-up','strip','rebooting','about-lfs','about-sbus']) :
